...
import br.com.alura.hotel.ListaReservas;
...
public class ListaReservasController implements Initializable {
    @FXML
    private TableView<Reservas> tabReservas;
    @FXML
    private TableColumn<Reservas, Integer> tabId;
    @FXML
    private TableColumn<Reservas, String> tabEntrada;
    @FXML
    private TableColumn<Reservas, String> tabSaida;
    @FXML
    private TableColumn<Reservas, Integer> tabDias;
    @FXML
    private TableColumn<Reservas, Integer> tabValor;
    @FXML
    private TableColumn<Reservas, String> tabSuite;
    @FXML
    private TableColumn<Reservas, String> tabPag;
    @FXML
    private TextField editEntrada;
    @FXML
    private TextField editSaida;
    @FXML
    private TextField editDias;
    @FXML
    private TextField editValor;
    @FXML
    private TextField editSuite;
    @FXML
    private TextField editFormPag;
    @FXML
    private Label labIdReserva;
    @FXML
