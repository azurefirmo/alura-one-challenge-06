...
import br.com.alura.hotel.ListaHospedes;
...
public class ListaHospedesController implements Initializable {
    ...
    @FXML
    private TableView<Hospedes> tabelaMostraHospedes;
    @FXML
    private TableColumn<Hospedes, Integer> idColTabHospedes;
    @FXML
    private TableColumn<Hospedes, String> nomeColTabHospedes;
    @FXML
    private TableColumn<Hospedes, String> sobrenomeColTabHospedesaida;
    @FXML
    private TableColumn<Hospedes, String> nascimentoColTabHospedes;
    @FXML
    private TableColumn<Hospedes, String> nacionalidadeColTabHospedes;
    @FXML
    private TableColumn<Hospedes, String> telefoneColTabHospedes;
    @FXML
    private TableColumn<Hospedes, Integer> idReserva;
    @FXML
    private TextField campoPesquisa;
    @FXML
    private TextField edidNacao;
    @FXML
    private TextField editNascimento;
    @FXML
    private TextField editNome;
    @FXML
    private TextField editSobrenome;
    @FXML
    ...
    public void confirmaEdicao() {
        ...
        al.setTitle("Alteração de hóspede");
        al.setHeaderText("Hóspede\n" + editNome.getText() + " Id: " + labId.getText() + "\nserá alterado...");
        al.setContentText("Confirma as alterações?");
    ...
    public void confirmaExclusao() {
        ...
        Alert al = new Alert(Alert.AlertType.CONFIRMATION);
        al.setTitle("Exclusão de hóspede");
        al.setHeaderText("Hóspede\n" + editNome.getText() + " Id: " + labId.getText() + "\nserá excluído...");
        al.setContentText("Confirma a exclusão?");
    ...
    public void editaHospede() {
        ...
        if (dao.update(h)) {
            Alert al = new Alert(Alert.AlertType.INFORMATION);
            al.setHeaderText("Alteração realizada com sucesso");
            al.show();
        } else {
            Alert al = new Alert(Alert.AlertType.ERROR);
